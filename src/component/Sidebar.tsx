    ...
    <div className={`nav-container ${isOpen ? "open" : "collapsed"}`}>
      <div className="logo-container">
        <h2 className="brand-text">
          ...
          <SiShopware size={30} color="green" />
        </h2>
        <button
      ...
      <div className="navlist-container">
        <ul>
          <li
            className={`nav-name ${
              isLinkActive("/dashboard") ? "active-nav-link" : ""
            }`}
            onClick={() => {
              Navigate("/dashboard");
            }}
          ...
          <li
            className={`nav-name ${
              isLinkActive("/admin-panel") ? "active-nav-link" : ""
            }`}
            onClick={() => {
          ...
          <li
            className={`nav-name ${
              isLinkActive("/overview") ? "active-nav-link" : ""
            }`}
            onClick={() => {
              Navigate("/overview");
            }}
          ...
          <li
            className={`nav-name ${
              isLinkActive("/sales") ? "active-nav-link" : ""
            }`}
            onClick={() => {
              Navigate("/sales");
            }}
          ...
          <li
            className={`nav-name ${
              isLinkActive("/stock") ? "active-nav-link" : ""
            }`}
            onClick={() => {
              Navigate("/stock");
            }}
      ...
      <div className="nav-Account-container">
        <div>
          <div>
            {userInfo ? (
              userInfo.role === "admin" ? (
                <FaUserShield color="blue" size={45} />
              ) : (
                <FaUser color="green" size={45} />
              )
            ) : (
              <FaCircleQuestion color="red" size={45} />
            )}
          </div>
          <div>
        ...
        <div className="user-details-logout-main">
          <div className="icon-details-container">
            <div>
              {userInfo ? (
                userInfo.role === "admin" ? (
                  <FaUserShield color="blue" size={55} />
                ) : (
                  <FaUser color="green" size={55} />
                )
              ) : (
                <FaCircleQuestion color="red" size={55} />
              )}
            </div>
          </div>
